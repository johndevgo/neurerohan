...
export default function CaseStudiesPage() {
  return <>
    <PageIntro breadcrumbs={[{ label: "Insights", href: "/insights" }, { label: "Case studies" }]} eyebrow="Case studies / Inspectable platform evidence" title="Performance evidence with the numbers, period and limitations left visible." visual={agencyAssets.analytics}><p>These anonymised SEO and Google Ads records use the screenshots supplied for GrowthLabs. They show platform-reported visibility, clicks, costs and configured conversions. They do not convert those signals into unsupported claims about customers, revenue, rankings or causation.</p></PageIntro>
    ...
    <SearchEvidence eyebrow="SEO performance notes / Google Search Console" title="Organic search visibility across four supplied account captures." copy="The captures span an Australian marketing agency, Dubai and Sharjah tours, Dubai water-adventure rental and Texas HVAC. Read the displayed periods and metrics as account evidence, not a ranking or revenue promise." ids={["australian-agency", "dubai-tours", "dubai-water-adventure", "texas-hvac"]} />
