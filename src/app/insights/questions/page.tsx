...
export default function QuestionsPage() {
  return <>
    ...
    <section className="section signal-grid"><div className="shell grid gap-8 md:grid-cols-[1fr_3fr]"><p className="eyebrow">Ask the next question</p><div><h2 className="section-title">Bring the question your data cannot answer alone.</h2><p className="mt-6 max-w-2xl text-lg leading-8 text-black/65">Send your website, current channel and the decision you are trying to make. Rohan will identify the most useful review, page, campaign or measurement next step.</p><Link className="button button-primary mt-8" href="/contact">Contact GrowthLabs <Arrow /></Link></div></div></section>
