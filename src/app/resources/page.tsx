...
export const metadata = pageMetadata(
  ...
  "Download practical SEO audit, website launch, social media calendar and digital marketing brief templates from GrowthLabs.",
  "/resources",
);
...
export default function ResourcesPage() {
  return <>
    <PageIntro breadcrumbs={[{ label: "Resources" }]} eyebrow="Free resources / Templates · Checklists · Planning systems" title="Useful marketing resources you can put to work today." visual={agencyAssets.contentStrategy}><p>Download practical GrowthLabs templates for SEO audits, marketing briefs, website launches and social media planning. Every resource is editable, free to use internally and designed to improve the quality of the next decision—not capture an email address.</p></PageIntro>
