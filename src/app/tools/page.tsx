...
export const metadata = pageMetadata(
  "Free SEO, Google Ads & Marketing Tools | GrowthLabs",
  "Use free SEO ROI, Google Ads break-even, Meta Ads budget and UTM campaign planning tools in your browser. No account or backend required.",
  "/tools",
);
...
export default function ToolsPage() {
  return <>
    <PageIntro breadcrumbs={[{ label: "Tools" }]} eyebrow="Free tools / SEO · Google Ads · Meta Ads · Analytics" title="Marketing calculators built to expose the assumptions." visual={agencyAssets.analytics}><p>Use the free GrowthLabs tools to model SEO value, Google Ads break-even economics, Meta Ads budget scenarios and consistent campaign URLs. Every calculation stays in your browser and shows the formula, inputs and limitations behind the output.</p></PageIntro>
