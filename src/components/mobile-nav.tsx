  ...
  return (
    <div className="mobile-nav-root flex items-center gap-1.5 lg:hidden">
      ...
      {open && <div ref={panelRef} id="mobile-menu" className="mobile-menu-panel fixed z-50 flex flex-col overflow-y-auto overscroll-contain" aria-label="Mobile navigation">
        <div className="mobile-menu-heading"><span>Explore GrowthLabs</span><small>Services, evidence and practical knowledge</small></div>
        ...
        </div><p className="mobile-menu-specialisms">SEO <span>·</span> Google Ads <span>·</span> Meta Ads <span>·</span> CRO</p>
      </div>}
    </div>
  );
}
