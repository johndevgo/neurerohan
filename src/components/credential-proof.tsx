...
export function CredentialProof({ ids, title = "Platform credentials you can inspect—not a decorative logo wall.", copy = "GrowthLabs founder Rohan Neure has confirmed the supplied partner and certification artwork is authorised for the business. Each credential is shown in its original supplied form and placed beside the service it supports.", compact = false, sectionId }: Props) {
