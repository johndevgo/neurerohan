...
export function SiteFooter({ measurementEnabled = false }: { measurementEnabled?: boolean }) {
  return <footer className="site-footer border-t border-[var(--ink)] bg-[var(--ink)] text-[var(--paper)]">
    ...
    <div className="shell grid gap-12 py-12 md:grid-cols-[1.35fr_.8fr_.9fr_.95fr] md:py-16">
      ...
      <div><p className="eyebrow !text-white/65">Explore</p><div className="mt-4 grid gap-2"><Link className="w-fit text-sm hover:text-[var(--sun)]" href="/seo-expert-in-nepal">SEO expert in Nepal</Link><Link className="w-fit text-sm hover:text-[var(--sun)]" href="/google-ads-agency-in-nepal">Google Ads agency</Link><Link className="w-fit text-sm hover:text-[var(--sun)]" href="/meta-ads-agency-in-nepal">Meta Ads agency</Link><Link className="w-fit text-sm hover:text-[var(--sun)]" href="/insights/case-studies">Case studies</Link><Link className="w-fit text-sm hover:text-[var(--sun)]" href="/resources">Resources</Link><Link className="w-fit text-sm hover:text-[var(--sun)]" href="/tools">Free tools</Link></div></div>
