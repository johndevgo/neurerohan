...
export function SiteHeader() {
  ...
  return <header className="sticky top-0 z-[100] border-b border-[var(--ink)] bg-[var(--paper)]">
    <div className="shell flex h-[var(--header)] items-center justify-between gap-2 lg:gap-6">
      ...
      <div className="hidden items-center gap-7 lg:flex"><DesktopNav items={navigation} /><Link className="button button-primary min-h-11 px-4" href={siteConfig.cta.primary.href}>{siteConfig.cta.primary.label} <Arrow direction="up-right" /></Link></div>
