  ...
  insights: {
    ...
    groups: [
      ...
      { title: "New deep guides", links: [
        { label: "Technical SEO audit", href: "/insights/technical-seo-audit-checklist", copy: "A prioritised crawl-to-conversion framework" },
        { label: "Google Ads tracking", href: "/insights/google-ads-conversion-tracking-guide", copy: "Conversion architecture and QA" },
        { label: "Meta creative testing", href: "/insights/meta-ads-creative-testing-framework", copy: "Test hypotheses, not random ads" },
        { label: "Local ranking factors", href: "/insights/local-seo-ranking-factors-guide", copy: "Relevance, distance and prominence" },
      ] },
    ],
  },
};
