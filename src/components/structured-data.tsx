...
const serviceSchemas: Record<string, ServiceSchemaConfig> = {
  ...
  "/technical-seo-services-in-nepal": {
    path: "/technical-seo-services-in-nepal",
    pageName: "Technical SEO Services in Nepal | GrowthLabs",
    breadcrumbName: "Technical SEO Services in Nepal",
    description: "Technical SEO services in Nepal covering crawling, indexing, rendering, canonicals, sitemaps, internal architecture, migrations, structured data and validation.",
    serviceName: "Technical SEO services in Nepal",
    serviceType: "Technical search engine optimisation",
    audience: "Businesses seeking crawl, indexation, rendering, migration and technical SEO implementation support",
    categories: ["Technical SEO", "Crawling", "Indexing", "JavaScript SEO", "Canonicalisation", "Website migrations"],
    offers: [
      { name: "Technical discovery", anchor: "technical-discovery", serviceType: "Technical SEO discovery and crawl modelling" },
      { name: "Crawling and indexation analysis", anchor: "crawling-indexing", serviceType: "Search crawling and indexing analysis" },
      { name: "Rendering review", anchor: "rendering", serviceType: "JavaScript rendering and crawler-access review" },
      { name: "Canonical control", anchor: "canonicals", serviceType: "Canonical and duplicate-URL analysis" },
      { name: "Website architecture review", anchor: "architecture", serviceType: "Internal architecture and discovery review" },
      { name: "Technical performance review", anchor: "performance", serviceType: "Mobile and technical performance review" },
      { name: "Structured data validation", anchor: "structured-data", serviceType: "Structured data and metadata validation" },
      { name: "Migration and implementation QA", anchor: "migration-qa", serviceType: "SEO migration planning and production validation" },
    ],
  },
  "/analytics-conversion-tracking-services": {
    path: "/analytics-conversion-tracking-services",
    pageName: "Analytics & Conversion Tracking Services | GrowthLabs",
    breadcrumbName: "Analytics & Conversion Tracking",
    description: "Analytics and conversion tracking services covering GA4, Google Tag Manager, Google Ads events, Meta signals, consent, QA and decision-led reporting.",
    serviceName: "Analytics and conversion tracking services",
    serviceType: "Digital analytics, tag management and advertising conversion measurement",
    audience: "Businesses seeking reliable website, advertising and qualified-conversion measurement",
    categories: ["Google Analytics 4", "Google Tag Manager", "Google Ads conversion tracking", "Meta Pixel", "Marketing analytics"],
    offers: [
      { name: "Measurement strategy", anchor: "measurement-strategy", serviceType: "Measurement planning and event taxonomy" },
      { name: "GA4 architecture", anchor: "ga4", serviceType: "Google Analytics 4 event architecture and review" },
      { name: "Google Tag Manager implementation", anchor: "tag-manager-implementation", serviceType: "Google Tag Manager architecture and validation" },
      { name: "Google Ads conversion measurement", anchor: "google-ads-conversions", serviceType: "Google Ads conversion action planning and validation" },
      { name: "Meta measurement signals", anchor: "meta-signals", serviceType: "Meta Pixel and paid-social event planning" },
      { name: "Consent-aware measurement", anchor: "consent", serviceType: "Consent and data-minimisation planning" },
      { name: "UTM governance", anchor: "utm-governance", serviceType: "Campaign taxonomy and UTM governance" },
      { name: "Tracking validation and reporting", anchor: "validation-reporting", serviceType: "Conversion tracking QA and decision reporting" },
    ],
  },
  "/content-marketing-agency-in-nepal": {
    path: "/content-marketing-agency-in-nepal",
    pageName: "Content Marketing Agency in Nepal | GrowthLabs",
    breadcrumbName: "Content Marketing Agency in Nepal",
    description: "Content marketing services in Nepal covering audience research, topic architecture, SEO briefs, expert input, editorial systems, distribution and conversion paths.",
    serviceName: "Content marketing services in Nepal",
    serviceType: "SEO content strategy, editorial systems and commercial content marketing",
    audience: "Businesses seeking useful search-led content, expert-informed editorial systems and commercial content journeys",
    categories: ["Content marketing", "SEO content", "Keyword clustering", "Topic architecture", "Editorial strategy", "Conversion copywriting"],
    offers: [
      { name: "Audience and decision research", anchor: "audience-research", serviceType: "Audience and content decision research" },
      { name: "Keyword clustering", anchor: "keyword-clustering", serviceType: "Keyword clustering and page-intent ownership" },
      { name: "Topic architecture", anchor: "topic-architecture", serviceType: "Topic, entity and internal-link architecture" },
      { name: "SEO content briefs", anchor: "content-briefs", serviceType: "SEO and expert-content briefing" },
      { name: "Expert-led content", anchor: "expert-content", serviceType: "Subject-matter-expert content development" },
      { name: "Commercial content", anchor: "commercial-content", serviceType: "Commercial content and conversion copywriting" },
      { name: "Editorial workflow", anchor: "editorial-workflow", serviceType: "Editorial governance and quality assurance" },
      { name: "Content distribution and measurement", anchor: "distribution-measurement", serviceType: "Content distribution and performance review" },
    ],
  },
...
function servicesSchema(): JsonLdNode {
  ...
  const routeMap: Record<string, string> = {
    ...
    "Content Marketing": `${siteConfig.domain}/content-marketing-agency-in-nepal`,
    "Analytics and Tracking": `${siteConfig.domain}/analytics-conversion-tracking-services`,
  };
